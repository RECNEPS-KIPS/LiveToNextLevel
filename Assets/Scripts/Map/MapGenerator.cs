...
public class MapGenerator : MonoBehaviour {
    ...
    public void GenerateMap() {
        ...
        maskLeft.localScale = new Vector3((mapMaxSize.x - currentMap.mapSize.x) / 2f, 1 * obsWallHeight, currentMap.mapSize.y) * tileSize;
        ...
        maskRight.localScale = new Vector3((mapMaxSize.x - currentMap.mapSize.x) / 2f, obsWallHeight * 1, currentMap.mapSize.y) * tileSize;
        ...
        maskTop.localScale = new Vector3(mapMaxSize.x, obsWallHeight * 1, (mapMaxSize.y - currentMap.mapSize.y) / 2f) * tileSize;
        ...
        maskBottom.localScale = new Vector3(mapMaxSize.x, obsWallHeight * 1, (mapMaxSize.y - currentMap.mapSize.y) / 2f) * tileSize;
